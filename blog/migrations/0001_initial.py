# Generated by Django 4.0.3 on 2022-06-15 07:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('path', models.ImageField(upload_to='D:\\Python-projects\\djangoBlog\\media\\uploads/images')),
            ],
            options={
                'verbose_name': 'Image',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('slug', models.SlugField(max_length=40, unique=True)),
                ('post_date', models.DateField(default=datetime.date(2022, 6, 15))),
            ],
            options={
                'verbose_name': 'Post',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(upload_to='D:\\Python-projects\\djangoBlog\\media\\uploads/images')),
                ('favicon', models.ImageField(upload_to='D:\\Python-projects\\djangoBlog\\media\\uploads/images')),
            ],
            options={
                'abstract': False,
            },
